...
if __name__ == '__main__':
    ...
    for hyparam in ParameterGrid(param_grid):
        # Experiment name
        experiment_name = ''
        for key, value in hyparam.items():
        ...
        test_env_setting['start_date'] = '2020-12-31'
        test_env_setting['end_date'] = None
        ...
        model_config = ModelConfig(
            ...
            tanh_action=hyparam['tanh'],
            use_GAE=hyparam['use_GAE'],
            fix_var_param=hyparam['fix_var_param'],
        )
